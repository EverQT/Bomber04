...
bool MapGenerator::crearObjetosJuego(string _path)
{
	...
	Texture* texturaMuroSpace;
	texturaMuroSpace = new Texture();
	Texture* texturaSueloHielo;
	texturaSueloHielo = new Texture();
	Texture* texturaMuroHielo;
	texturaMuroHielo = new Texture();
	...
	texturaMuroSpace->loadFromImage("resources/muro_space.jpg");
	texturaSueloHielo->loadFromImage("resources/suelo_hielo.jpg");
	texturaMuroHielo->loadFromImage("resources/muro_hielo.jpg");
			...
			if (chars[i] != ' ') {
				...
				case '2':
					...
					/*case 'B':
						...
						break;*/
				case '3':
					objetoNuevo = new MuroSpace(texturaMuroSpace, tileNuevo);
					break;
				case '4':
					objetoNuevo = new SueloHielo(texturaSueloHielo, tileNuevo);
					break;
				case '5':
					objetoNuevo = new MuroHielo(texturaMuroHielo, tileNuevo);
					if (x > bombermanPosicionX && bombermanPosicionX == -1) {
						bombermanPosicionX = x;
						bombermanPosicionY = y;
					}
